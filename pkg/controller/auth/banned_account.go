...
func (base *Controller) UnBanAccount(c *gin.Context) {
	var (
		req = models.UnBanAccountRequest{}
	)
	...
	code, err := auth.UnBanAccountService(base.Logger, base.Db, req)
	if err != nil {
	...
	rd := utility.BuildSuccessResponse(http.StatusOK, "unbanned account", nil)
	c.JSON(code, rd)
}
